...
abstract class BaseComiteFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'tih'             => new sfWidgetFormChoice(array('choices' => array('' => 'yes or no', 1 => 'yes', 0 => 'no'))),
      'nombretih'       => new sfWidgetFormFilterInput(),
      'comuna'          => new sfWidgetFormChoice(array('choices' => array('' => 'yes or no', 1 => 'yes', 0 => 'no'))),
      'nombrecomuna'    => new sfWidgetFormFilterInput(),
      'urbanismo'       => new sfWidgetFormChoice(array('choices' => array('' => 'yes or no', 1 => 'yes', 0 => 'no'))),
      'nombreurbanismo' => new sfWidgetFormFilterInput(),
    ...
    $this->setValidators(array(
      ...
      'tih'             => new sfValidatorChoice(array('required' => false, 'choices' => array('', 1, 0))),
      'nombretih'       => new sfValidatorPass(array('required' => false)),
      'comuna'          => new sfValidatorChoice(array('required' => false, 'choices' => array('', 1, 0))),
      'nombrecomuna'    => new sfValidatorPass(array('required' => false)),
      'urbanismo'       => new sfValidatorChoice(array('required' => false, 'choices' => array('', 1, 0))),
      'nombreurbanismo' => new sfValidatorPass(array('required' => false)),
